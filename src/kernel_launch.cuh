...
#include "kernels/tensorcore_6.cuh"
...
void tensorcore_6_launch(sgemm_params<half> device_sgemm_params, KernelLogger& timer, const unsigned int num_runs = 10)
{
    ...
    CUDA_CHECK(cudaFuncSetAttribute(tensorcore_6<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim>,
    cudaFuncAttributeMaxDynamicSharedMemorySize,
    65536)); // set shared memory limit to 64KB which is maximum for sm_75
...
void cublas_fp16_launch(sgemm_params<half> device_sgemm_params, KernelLogger& timer, const unsigned int num_runs = 10)
{
